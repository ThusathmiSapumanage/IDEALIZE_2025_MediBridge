          ...
          <div className="footer-content">
            ...
            <div className="footer-section">
              ...
              <div className="social-icons">
                <a href="https://facebook.com/medibridge" target="_blank" rel="noopener noreferrer">Facebook</a>
                <a href="https://twitter.com/medibridge" target="_blank" rel="noopener noreferrer">Twitter</a>
                <a href="https://instagram.com/medibridge" target="_blank" rel="noopener noreferrer">Instagram</a>
              </div>
            </div>
            <div className="footer-section">
              <h4>Legal</h4>
